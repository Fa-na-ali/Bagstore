...
const { addCoupon, getCoupons, deleteCoupon, getCouponById, editCoupon, getAllCouponsUser, applyCoupon, removeCoupon, unblockCoupon } = require('../controllers/couponController')
const { createOffer, getoffers, editOffer, deleteOffer, getOfferById, getAllOffers, unblockOffer } = require('../controllers/offerController')
...
router.route('/account/referrals/referral-code').post(authenticate, blockDisabledUsers, getReferralCode)
...
router.route("/:id/unblock").put(authenticate, authorizeAdmin, unblockUser)
...
router.route("/admin/coupons/:id/unblock").put(authenticate, authorizeAdmin, unblockCoupon)
...
router.route("/admin/offers/:id/unblock").put(authenticate, authorizeAdmin, unblockOffer)
