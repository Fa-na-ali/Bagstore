...
const { addProduct, deleteProduct, readProduct, deleteImage, updateProduct, fetchProducts, newProducts, fetchRelatedProducts, } = require('../controllers/productController')
const imageUpload = require('../imageUpload')

router.route('/new').get(newProducts)
router.route('/filter').get(authenticate)
router.route('/')
